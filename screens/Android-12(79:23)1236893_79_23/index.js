...
export class Blank extends React.Component {
  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.View_79_24}>
        <Text style={styles.Text_79_24}>AUDIT 5S</Text>
      </View>
      <View style={styles.View_79_25}>
        <Text style={styles.Text_79_25}>Éliminer</Text>
      </View>
      <View style={styles.View_79_52}>
        <View style={styles.View_79_26}>
          <View style={styles.View_I79_26_78_1}>
            <Text style={styles.Text_I79_26_78_1}> Score:</Text>
          </View>
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_I79_26_78_0}
          />
        </View>
        <View style={styles.View_79_27}>
          <View style={styles.View_I79_27_78_1}>
            <Text style={styles.Text_I79_27_78_1}>Description :</Text>
          </View>
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_I79_27_78_0}
          />
        </View>
        <View style={styles.View_79_49}>
          <View style={styles.View_I79_49_78_1}>
            <Text style={styles.Text_I79_49_78_1}>Numéro :</Text>
          </View>
          <ImageBackground
            source={{
              uri:
            ...
            style={styles.ImageBackground_I79_49_78_0}
          />
        </View>
      </View>
      <View style={styles.View_79_30} />
      <View style={styles.View_79_33}>
        <View style={styles.View_I79_33_79_19} />
        <View style={styles.View_I79_33_79_21}>
          <Text style={styles.Text_I79_33_79_21}>Enregistrer</Text>
        </View>
      </View>
      <TouchableOpacity
        onPress={() =>
      ...
      >
        <View style={styles.View_79_53}>
          <View style={styles.View_I79_53_79_19} />
          <View style={styles.View_I79_53_79_21}>
            <Text style={styles.Text_I79_53_79_21}>Annuler</Text>
          </View>
        </View>
      </TouchableOpacity>
    </ScrollView>
