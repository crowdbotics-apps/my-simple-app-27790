  ...
  render = () => (
    <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <ImageBackground
        ...
        style={styles.ImageBackground_70_15}
      />
      <View style={styles.View_70_16}>
        <Text style={styles.Text_70_16}>AUDIT 5S</Text>
      </View>
      <View style={styles.View_70_17}>
        <Text style={styles.Text_70_17}>Créer une nouvelle Catégorie</Text>
      </View>
      <View style={styles.View_70_18}>
        <ImageBackground
          ...
          style={styles.ImageBackground_70_19}
        />
        <View style={styles.View_70_29}>
          <Text style={styles.Text_70_29}>Numéro de Catégorie</Text>
        </View>
      </View>
      <View style={styles.View_70_25}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/856c/36df/79e7e44fa9794117b714e5db37d4a060"
          }}
          style={styles.ImageBackground_I70_25_36_71}
        />
        <View style={styles.View_I70_25_36_83}>
          <Text style={styles.Text_I70_25_36_83}>Nom</Text>
        </View>
      </View>
      <View style={styles.View_70_28}>
        <ImageBackground
          source={{
            uri:
              "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/81d0/548f/53298ad0639ddeb62a0b89ff4d434959"
          }}
          style={styles.ImageBackground_I70_28_67_55}
        />
        <View style={styles.View_I70_28_67_56}>
          <Text style={styles.Text_I70_28_67_56}>+ Ajouter</Text>
        </View>
      </View>
    </ScrollView>
  )
